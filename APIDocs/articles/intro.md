...
1. [Excel Extract](ExcelExtract.html) - reads rows and columns from an Excel file and returns easily consumed JSON
2. [Excel Merge](ExcelMerge.html) - Merges data in JSON format with an Excel document given as a URL or as a Base64 encoded string
3. [Word Merge](WordMerge.html) - Merges data in JSON format with an Word document given as a URL or as a Base64 encoded string
